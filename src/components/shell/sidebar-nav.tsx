...
const ICONS: Record<string, string[]> = {
  ...
  upload: [
    "M9 8.25H7.5a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H15M9 12l3 3m0 0l3-3m-3 3V3",
  ],
  sparkles: [
...
const SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: "/properties", label: "Properties", icon: ICONS.home },
      { href: "/leads", label: "Leads", icon: ICONS.users },
      { href: "/import", label: "Import data", icon: ICONS.upload },
    ],
  },
  {
    title: "AI tools",
    items: [
      { href: "/assistant", label: "AI Assistant", icon: ICONS.sparkles },
      { href: "/calls", label: "Call summaries", icon: ICONS.phone },
